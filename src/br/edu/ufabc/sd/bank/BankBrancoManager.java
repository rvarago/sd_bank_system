 ...
 *
 */
public class BankBrancoManager {

	private static Long accountCodeGenerator = Long.valueOf(1);

	private BankClientService bankClientService;
	private AccountBrancoDAO accountDAO;

	public BankBrancoManager(BankClientService bankClientService, AccountBrancoDAO accountDAO) {
